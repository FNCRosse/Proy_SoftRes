...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <div class="container-fluid mb-4 ps-4">
        <div class="row gx-3">
            ...
            <!-- Número de Documento -->
            <div class="col-auto">
                <label for="txtNumeroDocFiltro" class="form-label">Número Documento</label>
                <asp:TextBox ID="txtNumeroDocFiltro" runat="server" CssClass="form-control" placeholder="Ej. 12345678" />
            </div>
            <!-- Tipo Documento -->
            <div class="col-auto">
