...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    <div class="text-start mb-3">
        <h1 class="h3 text-danger fw-bold mb-0 me-3">
            <i class="fas fa-gears me-2"></i>Mantenimiento de Clientes
        </h1>
    </div>
    <!-- Filtros para  -->
    <div class="container-fluid mb-4 ps-4">
        <div class="row gx-3">
            ...
            <!-- Tipo cliente -->
            <div class="col-auto">
                <label for="ddlRol" class="form-label">Tipo Cliente </label>
            ...
            <div class="col-auto d-flex align-items-end">
                ...
                <asp:HyperLink ID="lnkNuevoEmpleado" runat="server"
                    NavigateUrl="~/Views/Usuarios/registro_cliente.aspx"
                    CssClass="btn"
    ...
    <div class="row">
        <asp:GridView ID="dgvLocal" runat="server" AllowPaging="false" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Tipo Cliente" DataField="TipCliente" />
                ...
                <asp:BoundField HeaderText="Cantidad de Reservas" DataField="CantReservas" />
