        ...
        <div class="container">
            <div class="form-wrapper mx-auto">
                ...
                <div class="row g-4 justify-content-center">
                    <!-- Nombre del evento -->
                    <div class="col-md-10">
                        <label class="form-label campo-label">Nombre del evento</label>
                        <input type="text" class="form-control custom-input" placeholder="nombre del evento" />
                    </div>

                    <!-- Descripción del evento -->
                    <div class="col-md-10">
                        <label class="form-label campo-label">Descripción del evento</label>
                        <textarea class="form-control custom-input" rows="3" placeholder="Escriba sus observaciones aquí..."></textarea>
                    </div>
